...
\vspace{10pt}
\begin{indented}
\item[]\textbf{Version 1.0} -- February 2026
\end{indented}
...
D_M(z)=
\cases{
\frac{1}{\sqrt{\Omega_k}}\sinh\!\left(\sqrt{\Omega_k}\,\chi(z)\right), & $\Omega_k>0$,\\
\chi(z), & $\Omega_k=0$,\\
\frac{1}{\sqrt{|\Omega_k|}}\sin\!\left(\sqrt{|\Omega_k|}\,\chi(z)\right), & $\Omega_k<0$.
}
\end{equation}
